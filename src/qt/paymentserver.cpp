...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click catcoin: links)
...
{
    // clicking on catcoin: URLs creates FileOpen events on the Mac:
