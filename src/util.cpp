...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CatCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CatCoin
    // Mac: ~/Library/Application Support/CatCoin
    // Unix: ~/.catcoin
#ifdef WIN32
    // Windows
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No catcoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override catcoin.conf
